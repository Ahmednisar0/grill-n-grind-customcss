...
export const featuredProducts: Products = [
  ...
  },
  {
    ...
    desc: "Experience a taste of the tropics with a juicy beef patty glazed in tangy teriyaki sauce, topped with grilled pineapple, crispy bacon, fresh lettuce, and all the classic fixings on a toasted bun.",
    img: "/images/p9.png",
    price: 29.9,
    options: [
      {
